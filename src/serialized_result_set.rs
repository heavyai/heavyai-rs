...
pub struct TResultSetLayout(pub i32);

impl TResultSetLayout {
  pub const GROUP_BY_PERFECT_HASH: TResultSetLayout = TResultSetLayout(0);
  pub const GROUP_BY_BASELINE_HASH: TResultSetLayout = TResultSetLayout(1);
  pub const PROJECTION: TResultSetLayout = TResultSetLayout(2);
  pub const NON_GROUPED_AGGREGATE: TResultSetLayout = TResultSetLayout(3);
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::GROUP_BY_PERFECT_HASH,
    Self::GROUP_BY_BASELINE_HASH,
    Self::PROJECTION,
    Self::NON_GROUPED_AGGREGATE,
  ];
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TResultSetLayout> {
    ...
    Ok(TResultSetLayout::from(enum_value))
  }
}

impl From<i32> for TResultSetLayout {
  fn from(i: i32) -> Self {
    match i {
      0 => TResultSetLayout::GROUP_BY_PERFECT_HASH,
      1 => TResultSetLayout::GROUP_BY_BASELINE_HASH,
      2 => TResultSetLayout::PROJECTION,
      3 => TResultSetLayout::NON_GROUPED_AGGREGATE,
      _ => TResultSetLayout(i)
    }
  }
}
...
impl From<&i32> for TResultSetLayout {
  fn from(i: &i32) -> Self {
    TResultSetLayout::from(*i)
  }
}

impl From<TResultSetLayout> for i32 {
  fn from(e: TResultSetLayout) -> i32 {
    e.0
  }
}
...
#[derive(Copy, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct TCountDistinctImplType(pub i32);

impl TCountDistinctImplType {
  pub const INVALID: TCountDistinctImplType = TCountDistinctImplType(0);
  pub const BITMAP: TCountDistinctImplType = TCountDistinctImplType(1);
  pub const UNORDERED_SET: TCountDistinctImplType = TCountDistinctImplType(2);
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::INVALID,
    Self::BITMAP,
    Self::UNORDERED_SET,
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TCountDistinctImplType> {
    let enum_value = i_prot.read_i32()?;
    Ok(TCountDistinctImplType::from(enum_value))
  }
}

impl From<i32> for TCountDistinctImplType {
  fn from(i: i32) -> Self {
    match i {
      0 => TCountDistinctImplType::INVALID,
      1 => TCountDistinctImplType::BITMAP,
      2 => TCountDistinctImplType::UNORDERED_SET,
      _ => TCountDistinctImplType(i)
    }
  }
}
...
impl From<&i32> for TCountDistinctImplType {
  fn from(i: &i32) -> Self {
    TCountDistinctImplType::from(*i)
  }
}

impl From<TCountDistinctImplType> for i32 {
  fn from(e: TCountDistinctImplType) -> i32 {
    e.0
  }
}
...
#[derive(Copy, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct TAggKind(pub i32);

impl TAggKind {
  pub const AVG: TAggKind = TAggKind(0);
  pub const MIN: TAggKind = TAggKind(1);
  pub const MAX: TAggKind = TAggKind(2);
  pub const SUM: TAggKind = TAggKind(3);
  pub const COUNT: TAggKind = TAggKind(4);
  pub const APPROX_COUNT_DISTINCT: TAggKind = TAggKind(5);
  pub const SAMPLE: TAggKind = TAggKind(6);
  pub const SINGLE_VALUE: TAggKind = TAggKind(7);
  pub const ENUM_VALUES: &'static [Self] = &[
    Self::AVG,
    Self::MIN,
    Self::MAX,
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TAggKind> {
    let enum_value = i_prot.read_i32()?;
    Ok(TAggKind::from(enum_value))
  }
}

impl From<i32> for TAggKind {
  fn from(i: i32) -> Self {
    match i {
      0 => TAggKind::AVG,
      1 => TAggKind::MIN,
      ...
      3 => TAggKind::SUM,
      4 => TAggKind::COUNT,
      5 => TAggKind::APPROX_COUNT_DISTINCT,
      6 => TAggKind::SAMPLE,
      7 => TAggKind::SINGLE_VALUE,
      _ => TAggKind(i)
    }
  }
}
...
impl From<TAggKind> for i32 {
  fn from(e: TAggKind) -> i32 {
    e.0
  }
}
